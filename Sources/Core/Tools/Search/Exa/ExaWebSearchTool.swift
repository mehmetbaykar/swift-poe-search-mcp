...
struct ExaWebSearchTool: MCPTool {
  ...
  struct Parameters: Sendable {
    ...
    /// Search algorithm: auto (balanced), neural (semantic), deep (comprehensive), fast (quick)
    ...
    /// Comma-separated domains to include (e.g., "arxiv.org,github.com")
  ...
  func call(with arguments: Parameters) async throws(ToolError) -> Content {
    ...
    if let v = arguments.searchType { extraBody["search_type"] = v.rawValue }
